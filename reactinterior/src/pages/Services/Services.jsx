...
import PricingCard from '../../contexts/PricingCard';
...
const Services = () => {
  ...
  const services = [
    {
      ...
      learnMoreLink: "/services/residential-design"
    },
    {
      ...
      learnMoreLink: "/services/commercial-design"
    },
    {
      ...
      learnMoreLink: "/services/office-interiors"
    },
    {
      ...
      learnMoreLink: "/services/custom-furniture"
    },
    {
      ...
      learnMoreLink: "/services/3d-design"
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-white">
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div 
                key={index} 
                className="bg-white rounded-xl p-6 border border-amber-100 hover:border-amber-300 transition-all duration-300 hover:transform hover:scale-105 shadow-lg"
              >
                {/* Service Title */}
                ...
                {/* Features List */}
                <div className="mb-4">
                  <h4 className="text-gray-800 font-semibold mb-2">What's Included:</h4>
                ...
                <div className="flex justify-between items-center mt-6">
                  ...
                  <a 
                    ...
                    className="bg-amber-600 text-white px-4 py-2 rounded-lg hover:bg-amber-700 transition-colors text-sm font-semibold"
                  >
                    Learn More
                  </a>
                </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-amber-700">15+ years of experience in interior design and execution</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-amber-700">We complete projects within agreed timelines</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-amber-700">No hidden costs, clear breakdown of all expenses</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-amber-700">Premium materials and craftsmanship guaranteed</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 bg-gradient-to-b from-amber-500 to-amber-600">
        <div className="container mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              href="/contact" 
              className="bg-white text-amber-700 px-8 py-4 rounded-lg hover:bg-amber-50 font-semibold text-lg transition-colors shadow-lg"
            >
              BOOK CONSULTATION
            </a>
            <a 
              href="tel:+9567894823" 
              className="border-2 border-white text-white px-8 py-4 rounded-lg hover:bg-white hover:text-amber-700 font-semibold text-lg transition-colors"
            >
              CALL: +956 789 4823
            </a>
          </div>
